...
Rx = 5e-2;      % Resistans
gamma = 1e5;    % parameter för att justera inspänning
u = 1;          % enhetssteg
...
simTime2 = 3*1e-4;                           % total simuleringstid (elek)
...
hold on												               	 % plotta i samma figur
plot(yprimout2, 'DisplayName', "Ström [A, Q/t]", 'LineWidth', 3)     % plot hastighet
hold off												             % sluta plotta i samma figur
title('Simulering av Laddningens oscillation i ett elektriskt system')% titel
xlabel("tid [",num2str(simTime2/3),"s]")			                 % x-ettikett
grid on											            		 % rutnät på
legend('show')											             % funktionsettiketter på
